...
class UniformNegativeSamplingTransform(BaseTransform):
    ...
    .. code-block:: python
        ...
        >>> print(output_batch)
        {'item_id': tensor([[1, 0, 4]]), 'negative_labels': tensor([1, 2])}
    ...
    def __init__(
        ...
        *,
        ...
        """
        if (
            sample_distribution is not None
            and sample_distribution.size(-1) != vocab_size
        ):
            msg = (
    ...
    def forward(self, batch: dict[str, torch.Tensor]) -> dict[str, torch.Tensor]:
        ...
        batch[self.out_feature_name] = negatives.to(
