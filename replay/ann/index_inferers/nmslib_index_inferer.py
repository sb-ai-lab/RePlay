...
from replay.ann.index_inferers.nmslib_index_inferer_mixin import (
    NmslibIndexInfererMixin,
)
        ...
        def infer_index_udf(
            ...
            index = index_store.load_index(
                ...
                configure_index=lambda index: index.setQueryTimeParams(
                    {"efSearch": index_params.efS}
                )
                if index_params.efS
                else None,
            )

            user_vectors = NmslibIndexInfererMixin.get_csr_matrix(
