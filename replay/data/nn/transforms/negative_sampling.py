...
class UniformNegativeSamplingTransform(BaseTransform):
    ...
    def __init__(
        ...
        *,
        out_column: Optional[str] = "negative_labels",
        ...
        :param out_column: The name of result feature in batch.
    ...
    def forward(self, batch: dict[str, torch.Tensor]) -> dict[str, torch.Tensor]:
        ...
        batch[self.out_column] = negatives.to(device=next(iter(batch.values())).device)
        return batch
