...
from replay.data.parquet.impl.masking import (
    DEFAULT_COLLATE_FN,
    DEFAULT_MAKE_MASK_NAME,
    DEFAULT_REPLICAS_INFO,
    GeneralCollateFn,
)
from replay.data.parquet.info.replicas import ReplicasInfoProtocol
from replay.data.parquet.utils.compute_length import compute_fixed_size_length
...
class ParquetDataset(IterableDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.iterator: BatchesIterator = BatchesIterator(
    ...
    def __len__(self) -> int:
        ...
        msg = (
            "This instance doesn't support `len()` method. You can enable it by setting `do_compute_length=True`."
        )
        raise TypeError(msg)
