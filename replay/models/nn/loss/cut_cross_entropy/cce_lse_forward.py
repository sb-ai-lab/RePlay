...
from .tl_autotune import cce_forward_autotune, cce_sampled_forward_autotune
...
_cce_lse_forward_kernel = triton.heuristics(  # type: ignore
    {
        ...
        "DOT_PRECISION": lambda args: "tf32" if torch.get_float32_matmul_precision() == "high" else "ieee",
    }
