...
Некоторые метрики оценивают рекомендации, не сравнивая их с ``ground_truth``.
Такие метрики инициализируются логом, а при вызове передается только список рекомендаций.
