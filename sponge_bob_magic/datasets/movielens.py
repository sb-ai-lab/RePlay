...
class MovieLens(Dataset):
    ...
    наверное, самый популярный датасет по рекемендациям.
    Содержит информацию об оценках фильмов на платформе grouplens.

    Некоторые версии датасета содержат дополнительную информацию о пользователях или тэгах.
