...
class Netflix(Dataset):
    """
    Датасет, использовавшийся в `Netflix Prize <https://www.kaggle.com/netflix-inc/netflix-prize-data>`_
    ...
    .. note::
        В первую загрузку чтение будет происходить долго, около 7 минут из-за
        парсинга дат. В последствии будет читаться быстро т.к. будет оставлен
        только обработанный паркет файл.
