"""
Обычные сплиттеры делят лог оценок несколькими способами:
...
"""
#TODO: как вообще в логе могут оказаться холодные предметы?
# мы же не передаем минимальное количество, по которому хотим выкидывать, а зря
...
class ColdUsersSplitter(Splitter):
    ...
    """
    # TODO: А что происходит с логом, если даты вообще нет?!
    def __init__(self,
                 test_size: float,
                 drop_cold_items: bool = False,
                 drop_cold_users: bool = False):
