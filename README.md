...
Для всех базовых алгоритмов выдача рекомендаций (inference) реализована с использованием PySpark.
...
Подробнее об алгоритмах в документации RePlay.

## Метрики
В библиотеке реализованы метрики для оценки качества (классификации и ранжирования), а также разнообразия рекомендуемых объектов.
...
## Сценарии
В RePlay реализованы сценарии — пайплайны, объединяющие применение нескольких модулей библиотеки, включая:
