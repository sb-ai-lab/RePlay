...
from replay.data.parquet.impl.sequence_column import SequenceColumn, to_torch
...
def test_pyarrow_sequence(torch_dtype: torch.dtype):
    ...
    sequence_column: SequenceColumn = SequenceColumn(
        data=torch_array,
        lengths=lengths,
        sequence_length=2,
    )
