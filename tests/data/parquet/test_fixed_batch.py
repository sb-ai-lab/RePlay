...
from replay.data.parquet.fixed_batch_dataset import FixedBatchSizeDataset, GeneralBatch, get_batch_size, DatasetProtocol
...
def test_strict_batch_size_mismatch():
    malformed_batch = {
        0: {"feature": torch.Tensor([3, 6, 8])},
        1: {"feature": torch.Tensor([5, 4])}
    }
