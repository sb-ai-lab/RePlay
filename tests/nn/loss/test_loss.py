...
@pytest.mark.parametrize(
    ...
    [
        ...
        (LogInCESampled()),
        (LogOutCE(ignore_index=3, vocab_size=3)),
        (LogOutCEWeighted(feature_name="sample_weights", ignore_index=3, vocab_size=3)),
    ],
    ids=[
        "CE",
        "CE weighted",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (LogInCESampled()),
        (LogOutCE(ignore_index=3, vocab_size=3)),
        (LogOutCEWeighted(feature_name="sample_weight", ignore_index=3, vocab_size=3)),
    ],
    ids=[
        "CE",
        "CE weighted",
