...
class DataPreparatorTest(PySparkTest):
    ...
    @parameterized.expand([
        ...
        ([["user1", "item1"],
         ...
         [["user1", "item1", datetime(1999, 5, 1), 'no_context', 1.0],
          ["user1", "item2", datetime(1999, 5, 1), 'no_context', 1.0],
          ["user2", "item1", datetime(1999, 5, 1), 'no_context', 1.0], ],
         {'user_id': 'user', 'item_id': 'item'}),
        ([["u1", "i10", '2045-09-18'],
          ["u2", "12", '1935-12-15'],
          ["u5", "303030", '1989-06-26'], ],
         ['user_like', 'item_like', 'ts'],
         [["u1", "i10", datetime(2045, 9, 18), 'no_context', 1.0],
          ["u2", "12", datetime(1935, 12, 15), 'no_context', 1.0],
          ["u5", "303030", datetime(1989, 6, 26), 'no_context', 1.0], ],
